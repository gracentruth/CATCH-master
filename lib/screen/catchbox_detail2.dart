      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          TextButton(
            ...
            child: Text('올리기', style: TextStyle(color: primary[40])),
          ),
        ],
        centerTitle: true,
      ),
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      child: Container(
                                                                          ...
                                                                          height: 30.h,
                                                                          decoration: BoxDecoration(
                                                                              color: x['choose']? primary[40] : Color(0xFFF3F4F5),
